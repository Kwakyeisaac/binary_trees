...
/**
 * levels_rec - It calls func on all nodes at each level.
...
/**
 * get_children - It appends children of parent to linked list.
...
/**
 * free_list - It frees all the nodes in a linked list
